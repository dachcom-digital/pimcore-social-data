pimcore.registerNS('SocialData.Component.Relation');
SocialData.Component.Relation = Class.create({
    ...
    generateElement: function () {
        ...
        this.href = Ext.create('SocialData.Component.RelationTextField', options);
